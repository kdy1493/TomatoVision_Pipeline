...
from .dinov2.dinov2.models.vision_transformer import vit_base, vit_large, vit_small
from .Utils import get_resize_keep_aspect_ratio


class BasicConv_IN(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride, padding, groups=1, with_bn=True, with_relu=True):
